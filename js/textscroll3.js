...
window.addEventListener('scroll', function () {
    ...
    // console.log("windowY", y);
    //use 300s opposite way to make it work

    var textbox = scrollingText.getBoundingClientRect(); //get text position
    var textboxY = textbox.top;
    // console.log("titleFrozen", titleFrozen);


    // console.log("textboxY", textboxY);

    // if (!scrollingUp && textboxY == 1 || scrollingUp && textboxY == 1) {
    //     windowYOnFreeze = window.scrollY;
    //     console.log("windowY", currWindowY);
    // }
